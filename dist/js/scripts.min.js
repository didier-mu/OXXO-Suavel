function validacionForm(){function e(e){if(e.val().length<1)e.siblings("span").remove(),e.after("<span class='error-input'>Campo requerido");else{e.siblings("span").remove();/^[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$/.test(e.val())?e.siblings("span").remove():(e.siblings("span").remove(),e.after('<span class="error-input"> No se permiten caracteres especiales </span>'),e.siblings("span").show())}}$("#btnEnviar").on("click",function(){$("#nombre"),$("#edad"),$("#estado");return id=$("#idTicket"),numeroTicket=$("#numeroTicket"),coments=$("#coments"),e(id),e(numeroTicket),e(coments),$("form .error-input").length,!1})}function validacionSesion(){$(".botonera a").on("click",function(e){0==$("#checkEdad").prop("checked")?($(".msjError").remove(),$("#cajaEdad").append('<span class="msjError" > Debes ser mayor de 18 años. </span>'),e.preventDefault()):0==$("#checkLegale").prop("checked")?($(".msjError").remove(),$("#cajaLegal").append('<span class="msjError" > Debes aceptar los términos y condiciones. </span>'),e.preventDefault()):$(".msjError").remove(),$("form .msjError").length}),$(".checkmark").on("click",function(){0==$("#checkLegale").prop("checked")&&$(".msjError").remove()})}function orden(e){window.matchMedia("(max-width: 992px)").matches?$(".registroSuavel--hero .row").append($("#imgCarro")):$(".registroSuavel--hero--arte").append($("#imgCarro"))}$(document).ready(function(){validacionSesion(),validacionForm(),orden(),$(window).resize(function(){orden()})});
