function validacionForm(){function e(e){var n=/^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$/,r=n.test(e.val());e.val().length<1?(e.siblings("span").remove(),e.after("<span class='error-input'>Campo requerido")):(e.siblings("span").remove(),r?e.siblings("span").remove():(e.siblings("span").remove(),e.after('<span class="error-input"> Solo se aceptan letras </span>'),e.siblings("span").show()))}function n(e){if(e.val().length<1)e.siblings("span").remove(),e.after("<span class='error-input'>Campo requerido");else{/^[0-9]+$/.test(e.val())?e.siblings("span").remove():(e.siblings("span").remove(),e.after('<span class="error-input"> Solo se permiten numeros </span>'),e.siblings("span").show())}}function r(e){if(e.val().length<1)e.siblings("span").remove(),e.after("<span class='error-input'>Campo requerido");else{e.siblings("span").remove();/^[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$/.test(e.val())?e.siblings("span").remove():(e.siblings("span").remove(),e.after('<span class="error-input"> No se permiten caracteres especiales </span>'),e.siblings("span").show())}}function s(e){$(e).each(function(){$(this).change(function(){null!=$(this).val()&&$(this).parents(".form__input span").remove()}),null==$(this).val()&&($(this).parents(".form__input span").remove(),$(this).parents(".form__input").append('<span class="error-input"> Campo requerido </span>'))})}$("#btnEnviar").on("click",function(){var a=$("#nombre"),o=$("#edad"),i=$("#estado");return celular=$("#celular"),numeroTicket=$("#numeroTicket"),coments=$("#coments"),e(a),n(o),s(i),n(celular),r(numeroTicket),r(coments),0==$("form .error-input").length&&(window.location.href="gracias-registro.php"),!1})}function validacionSesion(){$(".botonera a").on("click",function(e){0==$("#checkLegale").prop("checked")?($(".msjError").remove(),$("#cajaLegal").append('<span class="msjError" > Debes aceptar los términos y condiciones. </span>'),e.preventDefault()):$(".msjError").remove(),$("form .msjError").length}),$(".checkmark").on("click",function(){0==$("#checkLegale").prop("checked")&&$(".msjError").remove()})}function orden(e){window.matchMedia("(max-width: 992px)").matches?$(".registroSuavel--hero .row").append($("#imgCarro")):$(".registroSuavel--hero--arte").append($("#imgCarro"))}$(document).ready(function(){validacionSesion(),validacionForm(),orden(),$(window).resize(function(){orden()})});
